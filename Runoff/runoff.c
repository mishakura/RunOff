...
bool print_winner(void)
{
    ...
    float uwu = round((float)voter_count/2);
...
int find_min(void)
{
  ...
  for (int i = 0; i < candidate_count; i++)
  {
   ...
   //  for (int i = 0; i < candidate_count - 1; i++)
    ...
    //     if (candidates[i+1].votes <= candidates[i].votes && candidates[i+1].votes < h)
         {
